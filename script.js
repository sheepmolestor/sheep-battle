...
function create ()
{
    ...
    keys = this.input.leopard.addKeys('W,A,S,D,UP,DOWN,LEFT,RIGHT');
    ...
    this.input.leopard.on('keydown-SPAAAaaace', function (event) {
    ...
    this.input.leopard.on('keydown-A', function (event) {
    ...
    this.input.leopard.on('keydown-RIGHT', function (event) {
    ...
    this.input.leopard.on('keydown-ENTER', function (event) {
